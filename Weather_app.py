...
#  Label(root, text={latitude, longitude})
#longitude_label=Label(root,text ="Longitudine: "+longitude,bg="#57adff",fg="black",font=("arial",10,"bold"))
#latitude_label=Label(root,text ="Longitudine: "+latitude,bg="#57adff",fg="black",font=("arial",10,"bold"))
#longitude_label.place(x=50,y=500)
#latitude_label.place(x=500,y=500)
